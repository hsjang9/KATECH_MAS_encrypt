...
class Vehicle(RoadObject):
    ...
    def to_dict(self, origin_vehicle = None, observe_intentions: bool = True) -> dict:
        d = {
            'presence': 1,
            'x': self.position[0],
            'y': self.position[1],
            ...
            'absx': self.position[0],
            'absy': self.position[1],
            'absvx': self.velocity[0],
            'absvy': self.velocity[1],
            'px1': self.forward_path[0][0],
            'py1': self.forward_path[0][1],
            'px2': self.forward_path[1][0],
            'py2': self.forward_path[1][1],
            'px3': self.forward_path[2][0],
            'py3': self.forward_path[2][1],
            'px4': self.forward_path[3][0],
            'py4': self.forward_path[3][1],
            'px5': self.forward_path[4][0],
            'py5': self.forward_path[4][1]
        }
